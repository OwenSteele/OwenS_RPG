...
namespace Engine.Models
{
    public class Recipe
    {
        ...
        public string ToolTipContents =>
            ...
            "===========" + Environment.NewLine +
            string.Join(Environment.NewLine, Ingredients.Select(i => i.Description)) +
            Environment.NewLine + Environment.NewLine +
            "Creates" + Environment.NewLine +
            "===========" + Environment.NewLine +
            string.Join(Environment.NewLine, OutputItems.Select(i => i.Description));
        ...
        public void AddRequiredIngredient(int itemID, int quantity)
        {
